...
<Container>
<Effect name="fade-slide-right" timeout={300} durationA={500} easeA="preset:bounce" parameterA="20">
...
<Effect name="fade-slide-left" timeout={300} durationA={500} easeA="preset:bounce" parameterA="20">
