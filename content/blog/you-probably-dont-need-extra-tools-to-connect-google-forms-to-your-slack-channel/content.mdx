...
Sometimes instead of rushing into a third-party overkilling solution, it may be preferable to utilise your engineering skills. Of course, this is always a trade-off, but if you have time, then why not dare?
