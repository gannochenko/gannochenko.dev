...
In the previous article, we have discussed [how to use Serverless locally with Webpack and then deploy it to the AWS cloud](http://localhost:8000/blog/how-to-use-serverless-with-webpack-and-docker). Today we talk about how to spin up `Apollo GraphQL server` inside a lambda function.
...
Thanks for reading! Hope this article was helpful for you.
