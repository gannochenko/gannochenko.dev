...
Let's apply this formula to each byte of hex vector:
...
But against green background now it looks correct: <Color color="#00ff00" /><Color color="#EDB8BE" marginLeft="-10px" />

This calculator may help us to find out:
