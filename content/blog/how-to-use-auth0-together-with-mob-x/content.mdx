...
This solution is not ideal too: in case if I update a user, they will have to re-login to make effect. In my case it is not crucial since I don't plan to update users often.
