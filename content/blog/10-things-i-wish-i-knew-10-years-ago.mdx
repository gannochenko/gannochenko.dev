---
title: 10 things I wish I knew 10 years ago
description:
keywords:
path: /blog-drafts/10-things-i-wish-i-knew-10-years-ago
date: 2020-03-27
published: false
images:
    - author: Nicolas Häns
...
### Start small, but go full-cycle

Тут пример про 3d-моделирование

### Make a small step, get feedback, repeat
...
### Make something only when you have something new to say

### Threat your time dedication as an investment

### Think, but not too much (or too long)

### Automate everything you do, but only when it worth it
...
Don't try to be everybody. You only need to be somebody who knows their field, be open for brief experiencing other fields and knows how to organise everyone else to make a dream project.

==========

Except Bitcons. Well that is 11th thing.
...
### When making something new in completely unknown field start with something simple, but go full-cycle

Great things start as small things. Huge project will overwhelm you with complexity, and eventually there is high chance you'll give up. Small project, on the contrary, have higher chances to be completed (especially if the field is new). Completed projects bring satisfaction, it is something that you can present to somebody. Unfinished projects bring frustration and depression. "Well he has it, but it is not finished" - this is a shitty thing when it is spoken about you like this.
In the end it is better to have a wooden bicycle that can run, rather than three wheels and maybe a gearbox from Ferrari.

### Deliver first results and grab feedback as soon as possible. Then get feedback after every consequent step made.
